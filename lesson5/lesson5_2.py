...
class Window(ThemedTk):
    def __init__(self,*args,**kwargs):
        ...
        for size in sizes:
            r = ttk.Radiobutton(bottomFrame,text=size[0],value=size[1],variable=self.selected_size)
            r.pack(fill='x',padx=5,pady=5)

        # button
        button = ttk.Button(bottomFrame,text="Get Selected Size",command=self.show_selected_size)
